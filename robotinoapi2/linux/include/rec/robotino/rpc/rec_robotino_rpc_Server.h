	...
	namespace robotino
	{
		namespace rpc
		{
			...
			public Q_SLOTS:
				...
				bool set_upload_program(const QByteArray& jsonData, const QByteArray& payloadData);
			...
			private:
				...
				DECLARE_TOPICLISTENER(rec_robotino_rpc_fleetcom_response);
				DECLARE_TOPICINFOCHANGED(rec_robotino_rpc_fleetcom_response);

				DECLARE_TOPICLISTENER(rec_robotino_rpc_smartrobotinfo);
				DECLARE_TOPICINFOCHANGED(rec_robotino_rpc_smartrobotinfo);

				DECLARE_TOPICLISTENER(rec_robotino_rpc_smartjoblist);
				DECLARE_TOPICINFOCHANGED(rec_robotino_rpc_smartjoblist);
			};
		}
	}
}
